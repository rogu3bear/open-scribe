...
printf '%s\n' \
	...
	'excludes=microphone_capture,system_audio_capture,capture_permissions,first_sample_capture_evidence,multiple_required_sources,segment_sealing,real_forced_process_termination,playback,playable_recovery,disk_pressure,route_changes,recording,signing,notarization,distribution,release'
