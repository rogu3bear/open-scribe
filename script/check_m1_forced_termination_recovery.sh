...
printf '%s\n' \
	...
	'proof=interruption_state_regression,recovery_planning_before_mutation,journal_first_projection_repair,strict_unclosed_pcm_caf_validation,content_free_durable_recovery_receipt,ready_for_review_projection,persistent_recovered_conversation,native_playback_controller,real_microphone_first_sample,real_system_audio_first_sample,rust_owned_multi_source_recording,external_sigkill,relaunch_scan,atomic_two_track_recovery,independent_playable_media_decode,unchanged_media_digests,idempotent_relaunch,fresh_bindings,clean_arm64_macos13_tests,candidate_range_and_worktree_diff_hygiene' \
